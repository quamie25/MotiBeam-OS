...
class MotiBeamApp:
    ...
    def show_main_menu(self):
        ...
        menu_items = [
            ...
            {"key": "7", "name": "Smart Home/Family Dashboard", "symbol": "[🏠]", "color": self.colors['blue'], "demo": "home"},
        ]
        ...
        while menu_running and self.running:
            ...
            y_pos = 300  # Starting position moved up to fit 7 items
            y_spacing = 55  # Reduced spacing to fit all 7 items
